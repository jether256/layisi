...
class ProductByCategory extends StatefulWidget {
  ...
  ProductByCategory({ required this.categoryID, required this.categoryTitle, required this.categoryPic, required this.categoryStatus});
 ...
 // List<AdvertModel> products = [];
  showProducts() async {
    var response = await http.post(
        Uri.parse("https://layisikla.000webhostapp.com/api/gaetAllAdsCat.php"),
        headers: {"Accept": "headers/json"},
        body: {'category': widget.categoryID});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.categoryStatus=='0' ? 'Cars':'${widget.categoryTitle}',style: TextStyle(color: Colors.deepOrangeAccent),
        ),
            ...
            if (snapshot.hasData) {
              ...
              if(snapshot.data.length == 0) {
                return Center(
                  child: Column(
                    children: const [
                      Center(child: Text('No Ads in this category')),
                    ],
                  ),
                );
              }
        ...
        child: Padding(
          ...
          child:Stack(
            children: [
              ...
              //
              //         circleColor:
              //         CircleColor(start: const Color(0xff00ddff), end: const Color(0xff0099cc)),
