...
import 'package:layisi/forms/car_form.dart';
...
class SellerCategory extends StatefulWidget {
  ...
  @override
  _SellerCategoryState createState() => _SellerCategoryState();
}
        ...
        onTap: (){
          ...
          if(widget.categoryTitle=='Cars'){
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) =>    SellerCarForm(id:widget.categoryID,title:widget.categoryTitle),
                )
            );
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) =>   SellerSubCat(id:widget.categoryID,title:widget.categoryTitle),
                )
            );
